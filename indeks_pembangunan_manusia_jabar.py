...
with Jawa_Barat:
    ...
    with Kesimpulan:
        ...
        st.image("D:\DQLab\project-copy\TETRIS-Batch-4\ipm_jabar_2022_2023.png", caption="Indeks Pembangunan Manusia menurut Provinsi, 2022-2023", use_column_width=True)
